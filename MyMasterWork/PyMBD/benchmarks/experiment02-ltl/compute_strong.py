...
from pymbd.benchmark.ltl.ltlparser.ast import syntactic_equivalent
        ...
        while tries < 3 and not done:
            ...
            try:
                with timeout_monitor(int(timeout_seconds * 2), True):
                    ...
                    python_cmd = [PYTHONPATH, os.path.join(THIS_FILE_DIR, '../../pymbd/benchmark/ltl/compute_sample.py'), task.algorithm, str(task.card), str(timeout_seconds), "strong"]
