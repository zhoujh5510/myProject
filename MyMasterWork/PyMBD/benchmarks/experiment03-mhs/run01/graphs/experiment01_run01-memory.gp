...
set output "experiment01_run01-memory.tex"
...
lines = lines." ,".myline('bool-it-h5-stop', 	'Bool-It.-Opt', 6, 1, 20, 3, 'x', '')
lines = lines." ,".myline('saths', 				'HS-SAT', 		7, 1, 20, 1, 'x', '')
lines = lines." ,".myline('maxsaths', 			'HS-MaxSAT', 	8, 1, 20, 2, 'x', '')
lines = lines." ,".myline('bool-rec-h1-oldr4', 	'Bool-Rec.', 	9, 1, 20, 3, 'x', '')
plot @lines
