...
class d_loc_t(_object):
    ...
    __swig_setmethods__["pathname"] = _dparser_swigc.d_loc_t_pathname_set
    __swig_getmethods__["pathname"] = _dparser_swigc.d_loc_t_pathname_get
    if _newclass:pathname = _swig_property(_dparser_swigc.d_loc_t_pathname_get, _dparser_swigc.d_loc_t_pathname_set)
